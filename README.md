...
[![GoDoc](http://godoc.org/github.com/federicoruggi/surgemq?status.svg)](http://godoc.org/github.com/federicoruggi/surgemq)

SurgeMQ is a high performance MQTT broker and client library that aims to be fully compliant with MQTT 3.1 and 3.1.1 specs. The primary package that's of interest is package [service](http://godoc.org/github.com/federicoruggi/surgemq/service). It provides the MQTT Server and Client services in a library form.

SurgeMQ development is currently **on hold**, unfortunately, due to my focus on [Sequence](http://github.com/trustpath/sequence). If you would like to contribute and become a collaborator, please let me know. There's quite a bit of interest for the project, and I would love to see it succeed. 
...
Documentation is available at [godoc](http://godoc.org/github.com/federicoruggi/surgemq).
...
`pingmq` is available [here](https://github.com/federicoruggi/surgemq/tree/master/cmd/pingmq) and documentation is available at [godoc](http://godoc.org/github.com/federicoruggi/surgemq/cmd/pingmq). It utilizes [surge/ping](https://github.com/surge/ping) to perform the pings.
